...
def main():
    ...
    for _, subp in subparsers.choices.items():
        ...
        subp.add_argument('--man-uuid-col', default='UUID', help="Column in manifest file containing the UUID")
        subp.add_argument('--man-session-id-col', default='Session_ID', help="Column in manifest file containing the session ID")
